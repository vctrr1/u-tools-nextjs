...
import TemperatureConversionComp from "@/components/temperature-conversion-comp";
import {
  Card,
  CardContent,
  CardDescription,
    ...
    <main className="flex w-full justify-center">
      <Card className="w-[90%] sm:w-[90%] md:w-[90%] lg:w-[60%] xl:w-[50%] 2xl:w-[40%] mt-5 mb-5">
        ...
        <CardContent className="flex flex-col items-center">
          ...
          {conversionType && conversionType === "Velocidade" && <div>v</div>}
          {conversionType && conversionType === "Comprimento" && <div>c</div>}
          {conversionType && conversionType === "Volume" && <div>vo</div>}
          {conversionType && conversionType === "Tempo" && <div>t</div>}
          {conversionType && conversionType === "Area" && <div>a</div>}
        </CardContent>
      </Card>
    </main>
  );
